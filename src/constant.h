...
// These are used only in death.c and save.c.  I have different versioning
//#define CUR_VERSION_MAJ 5 /* version 5.5.2 */
//#define CUR_VERSION_MIN 5
//#define PATCH_LEVEL 2

// I will replace TRUE,FALSE with Boolean type, true, and false.
//#ifndef TRUE
//#define TRUE 1
//#endif
//#ifndef FALSE
...
// These can probably be replaced with something Palm-OS-SDK specific
// used in creature, recall, save
...
// used in dungeon, io, misc3, moria1, signals, store2
// this and other UI stuff will be revised
#define MSG_LINE  0

/* number of messages to save in a buffer */
// used in dungeon, io, save, variable
// ok if I have a message log like iRogue, I will still use this.
#define MAX_SAVE_MSG   22   /* How many messages to save -CJS- */

/* Dungeon size parameters					*/
// I would like to make the dungeon levels smaller if I can get away with it.
/* Max_Height is Multiple of 11; >= 22 */
#define MAX_HEIGHT  66
/* Max_Width is Multiple of 33; >= 66 */
#define MAX_WIDTH  198
/* my Max_Width is Multiple of 32; >= 32 */ // try to maintain ratio-to-screen
//#define MAX_WIDTH  192 // my attempt. was 96.
// Screen height and width might have to change.
// QUART_* are used only in generate, to determine room size..
#define SCREEN_HEIGHT  22
//#define SCREEN_WIDTH   66
#define SCREEN_WIDTH   64
#define SCREEN_WIDTH_REAL   32 // my attempt
#define QUART_HEIGHT (SCREEN_HEIGHT / 4)
#define QUART_WIDTH  (SCREEN_WIDTH / 4)
#define QUART_WIDTH_REAL  (SCREEN_WIDTH_REAL / 4)

// I expect not to change these, except where noted
...
// possible outcomes of haggling
#define HAG_ONGOING  0
#define HAG_BOUGHT   1
#define HAG_REJECTED 2
#define HAG_BOOTED   3
...
/* I would like to distinguish between 'wield' and 'wear' on my buttons: */
#define TV_MID_WEAR     30
#define TV_BOOTS	30
#define TV_GLOVES	31
#define TV_CLOAK	32
#define TV_HELM		33
...
// ok, I might be changing this!
#define SCOREFILE_SIZE	1000


/*
  Note:
  128          ; max signed char  0x7F
  32768        ; max signed short 0x7FFF
  2147483648.0 ; max signed long  0x7FFFFFFF
*/

// added to avoid function pointers
#define IS_CORR 1
#define IS_ROOM 2
#define IS_FLOOR 3
...
// Ok these are to tell me what I'm doing when I need a direction.
#define DIR_NONE    0
#define DIR_AIM     1 
#define DIR_BASH    2
#define DIR_CLOSE   3
...
#define DIR_TUNNEL  9
#define DIR_WEDGE  10
// more will be needed for directional spells/prayers
#define DIR_SPELLS 11

// Ok, these are to tell print_stats which stats lines to print.
#define STATS_QUO     0x1
#define STATS_TOGGLE  0x0
#define STATS_GOLD_AC 0x2
#define STATS_STR_ETC 0x4
#define STATS_WORD    0x8

// How many spells or prayers there are.  happens to be same number.
#define MAX_SPELLS 31

// for messages and message log.  hm, msglen was 70 in iLarn.
